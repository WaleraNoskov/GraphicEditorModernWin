...
public static class BusinessToOpenCvSharpTools
{
	...
	public static OpenCvSharp.Size To(this Core.ValueTypes.Size size) => new(size.Width, size.Height);
	public static Core.ValueTypes.Size ToSize(this OpenCvSharp.Size size) => new(size.Width, size.Height);
}
